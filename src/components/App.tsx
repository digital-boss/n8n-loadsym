    ...
    <div>
      <svg viewBox={viewBox.join(' ')} id="map-svg">
        <PanZoom matrix={matrix} setMatrix={setMatrix}>
          ...
          />
          <g id="NT" class={styles.territory}>
          ...
          <g id="TAS" class={styles.territory}>
          ...
          <g id="ACT" class={styles.territory}>
            <path
              stroke-width="1.5"
              stroke="#ffffff"
        ...
        <rect class={styles["plus-minus"]} x="23" y="20" width="4" height="1" />
        <rect class={styles["plus-minus"]} x="23" y="29" width="4" height="1" />
        <rect
